...
static const int64_t STATIC_POS_REWARD = 40 * COIN; //Constant reward of 14 BLT per COIN i.e. 8%
...
static const int64_t MAX_MONEY = 4000000000 * COIN;  // 4B COIN
...
inline int64_t GetMNCollateral(int nHeight) { return 8000000; }
