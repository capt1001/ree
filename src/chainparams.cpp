...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Ree 2.0 revival: we want ree clean";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1529400627;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 250057;

        hashGenesisBlock = genesis.GetHash();
        //printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
        //printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
	assert(hashGenesisBlock == uint256("0x6616914521cc0f2907ef0c1af960f82fc7624b664d7fbb17a56496e1afe913bc"));
        assert(genesis.hashMerkleRoot == uint256("0x0fd3a477bb4ef966adff655ca7c39657cd1b5a44b9a36b80ee5d52aba2cd085b"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x05)(0x28)(0xB1)(0x1C).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x05)(0x28)(0xAE)(0xA2).convert_to_container<std::vector<unsigned char> >();

        vSeeds.push_back(CDNSSeedData("n0", "193.37.152.99"));
        vSeeds.push_back(CDNSSeedData("n2", "23.95.214.48"));
        convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;
        //strSporkKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        //strMasternodePaymentsPubKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        strDarksendPoolDummyAddress = "RJ3Ae13X4nL5WjxWA8gmJi2PVUoWqGCGSR";
        nLastPOWBlock = 1013;
        nPOSStartBlock = 50;
    }
